...
All configuration is stored in PostgreSQL and managed through REST APIs. There are no local JSON files. Three entity types drive the system:
...
This calls the APIs to create each ICP, niche, and offering.
